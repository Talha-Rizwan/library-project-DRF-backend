...
from home.serializers import UserBookRequestSerializer, RequestTicketSerializer, UserRequestTicketSerializer
...
class UserRequestTicket(generics.ListCreateAPIView):
    ...
    serializer_class = UserRequestTicketSerializer
    permission_classes = [IsAuthenticated]
    authentication_classes = [JWTAuthentication]
